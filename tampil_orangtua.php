                    ...
                    <div class="panel panel-default">
                        ...
                        <tbody>
                            ...
                            while($row=mysqli_fetch_assoc($res))
                            {
                                ...
                                <td>".$row['nis']."</td>
                                <td>
                                <a href='#edit_data' class='btn btn-default btn-small' id='custId' data-toggle='modal' data-id=".$row['id_orangtua']."><img src='images/icons/ubah.gif'></a></td>
                                </td>
                                <td>
                                <a href='#hapus_data' class='btn btn-default btn-small' id='custId' data-toggle='modal' data-id=".$row['id_orangtua']."><img src='images/icons/hapus.gif'></a></td>
                                </td>
                                </tr>";
		    ...
		    <div class="modal-content">
		      <div class="modal-header">
		    	...
		    	<div class="modal-body">
		        	<form action="proses_tambah_data_orangtua.php" method="POST">
		          	<div class="form-group">
			            <label for="nama">Nama Orangtua:</label>
			            <input type="text" class="form-control" name="nama">
			        </div>
			        <div class="form-group">
			            <label for="mengajar">Nomor Telepon:</label>
...
<!-- Modal Konfirmasi -->                                                    
    ...
    $(document).ready(function(){
        $('#ubah').on('show.bs.modal', function (e) {
            var rowid = $(e.relatedTarget).data('id_orangtua');
