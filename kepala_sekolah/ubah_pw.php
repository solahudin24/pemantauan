...
if ( isset( $_POST[ 'nuptk' ] ) ) {
	...
	while ( $row = mysqli_fetch_assoc( $res ) ) {
		?>
		<form action="proses_ubah_pw_kepsek.php?nuptk=<?php echo $nuptk; ?>" method="POST" onSubmit="return confirm('Apakah anda yakin ingin menyimpan data?');" enctype="multipart/form-data">
