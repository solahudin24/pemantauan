...
if ( isset( $_SESSION[ 's_id_orangtua' ] ) ) {
  require "../koneksi.php";
  $link = koneksi_db();
  $title = 'Orangtua SLB C Sukapura Kota Bandung';
  $halaman = 'guru';
  require( '../header.php' );
      ...
      <ul class="nav navbar-top-links navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-user">
            <li class="divider"></li>
            <li><a href="#ubah_pw" id="custId" data-toggle="modal" data-id="<?php echo $_SESSION['s_id_orangtua'];?>"><i class="fa fa-edit fa-fw"></i> Ubah Password</a>
            </li>
