                    ...
                    <div class="panel panel-default">
                        ...
                        <li class="sidebar-search">
                            ...
                            <thead>
                              <tr>
                                ...
                                <th onclick='sortTable(2)'>Nama Siswa</th>
                                <th  onclick='sortTable(3)'>Alamat</th>
                                <th  onclick='sortTable(4)'>Nomor Telepon</th>
                        ...
                        <tbody>
                            ...
                            while($row=mysqli_fetch_assoc($res))
                            {
                                ...
                                <td>".$row['password']."</td>
                                <td>
                                <a href='#edit_data' class='btn btn-default btn-small' id='custId' data-toggle='modal' data-id=".$row['nis']."><img src='images/icons/ubah.gif'></a></td>
                                </td>
                                <td>
                                <a href='#hapus_data' class='btn btn-default btn-small' id='custId' data-toggle='modal' data-id=".$row['nis']."><img src='images/icons/hapus.gif'></a></td>
                                </td>
                                </tr>";
		    ...
		    <div class="modal-content">
		      <div class="modal-header">
		    	...
		    	<div class="modal-body">
			        ...
			        <div class="form-group">
			            <label for="mengajar">Alamat:</label>
...
<!-- Modal Konfirmasi -->                                                    
    ...
    $(document).ready(function(){
        $('#ubah').on('show.bs.modal', function (e) {
            var rowid = $(e.relatedTarget).data('nis');
